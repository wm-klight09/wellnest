        ...
        <Box>
          ...
          <Box display="flex" alignItems="center" gap={1}>
            ...
            <Typography variant="h4">
              {Math.round(weather.temp)}°C / {Math.round(celsiusToFahrenheit(weather.temp))}°F
            </Typography>
          </Box>
          
          <Typography variant="body2" color="textSecondary">
            Feels like: {Math.round(weather.feels_like)}°C / {Math.round(celsiusToFahrenheit(weather.feels_like))}°F
          </Typography>
